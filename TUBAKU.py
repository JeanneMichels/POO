...
class TelaTextoFase1(arcade.View):
    ...
    def on_draw(self):
        self.clear()
        arcade.draw_text("FASE 1 CONCLUÍDA!", LARGURA / 2, 500,
                         arcade.color.YELLOW, 26, anchor_x="center", bold=True)
        arcade.draw_text("CURIOSIDADE: ALIMENTAÇÃO DOS TUBARÕES", LARGURA / 2,
        ...
        texto = (
            ...
            "  campos elétricos emitidos por outros animais.\n"
        ...
        arcade.draw_text("Pressione [ESPAÇO] para ir para a Fase 2", LARGURA / 2,
...
class TelaTextoFase2(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text(texto, LARGURA / 2, 290, arcade.color.LIGHT_GRAY,
                         14, anchor_x="center", multiline=True, width=700)
        arcade.draw_text("Pressione [ESPAÇO] para ir para a Fase 3", LARGURA / 2,
                         80, arcade.color.GOLD, 16, anchor_x="center", bold=True)
...
class TelaTextoFase3(arcade.View):
    ...
    def on_draw(self):
        ...
        texto = (
            ...
            "• As orcas são golfinhos gigantes extremamente inteligentes que geralmente caçam em grupo.\n"
            ...
            "  um estado de paralisia chamado 'imobilidade tônica', tornando a caça mais fácil."
        )
        arcade.draw_text(texto, LARGURA / 2, 280, arcade.color.LIGHT_GRAY,
                         14, anchor_x="center", multiline=True, width=700)
...
class TelaInicial(arcade.View):
    ...
    def on_show_view(self):
        self.background_color = arcade.color.UCLA_BLUE

    def on_draw(self):
        self.clear()
        if not self.exibindo_objetivos:
            arcade.draw_text("COMEDOR DE PEIXES", LARGURA / 2, 420,
                             arcade.color.WHITE, 32, anchor_x="center", bold=True)
            arcade.draw_text("Pressione [J] para Jogar", LARGURA / 2,
                             320, arcade.color.LIGHT_SEA_GREEN, 18, anchor_x="center")
            arcade.draw_text("Pressione [O] para Ver os Objetivos", LARGURA / 2,
                             270, arcade.color.LIGHT_SEA_GREEN, 18, anchor_x="center")
            arcade.draw_text("Pressione [ESC] para Sair", LARGURA / 2,
                             220, arcade.color.LIGHT_SEA_GREEN, 18, anchor_x="center")
        else:
...
class TelaVitoria(arcade.View):
    ...
    def on_draw(self):
        self.clear()
        arcade.draw_text("PARABÉNS! VOCÊ VENCEU O OCEANO!", LARGURA / 2,
                         400, arcade.color.GOLD, 28, anchor_x="center", bold=True)
        arcade.draw_text(f"Pontuação Máxima: {self.pontuacao} pontos",
                         LARGURA / 2, 320, arcade.color.WHITE, 18, anchor_x="center")
        arcade.draw_text("Pressione [R] para Jogar Novamente", LARGURA / 2,
                         220, arcade.color.AQUAMARINE, 16, anchor_x="center")
        arcade.draw_text("Pressione [ESC] para Voltar ao Menu", LARGURA / 2,
                         170, arcade.color.AQUAMARINE, 16, anchor_x="center")
...
class TelaGameOver(arcade.View):
    ...
    def on_draw(self):
        self.clear()
        arcade.draw_text("GAME OVER", LARGURA / 2, 400,
                         arcade.color.WHITE, 40, anchor_x="center", bold=True)
        arcade.draw_text(f"Pontos acumulados: {self.pontuacao}", LARGURA / 2,
                         320, arcade.color.LIGHT_GRAY, 18, anchor_x="center")
        arcade.draw_text("Pressione [R] para Tentar Novamente",
                         LARGURA / 2, 220, arcade.color.YELLOW, 16, anchor_x="center")
        arcade.draw_text("Pressione [ESC] para Voltar ao Menu",
                         LARGURA / 2, 170, arcade.color.YELLOW, 16, anchor_x="center")
...
class TelaJogo(arcade.View):
    ...
    def on_draw(self):
        ...
        if self.fase == 1:
            ...
            if self.cenario_fase2:
                arcade.draw_texture_rect(
                    texture=self.cenario_fase2, rect=arcade.LBWH(0, 0, LARGURA, ALTURA))
            else:
        ...
        arcade.draw_text(f"Pontos: {self.pontuacao}",
                         10, 570, arcade.color.WHITE, 14, bold=True)
        arcade.draw_text(f"Fase: {self.fase}", LARGURA -
                         80, 570, arcade.color.WHITE, 14, bold=True)
